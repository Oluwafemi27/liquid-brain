...
import { n as globalthis_default, r as init_globalthis } from "../_libs/@e2b/code-interpreter+[...].mjs";
import { m as require_jsx_runtime } from "../_libs/@radix-ui/react-collapsible+[...].mjs";
import { r as csrfSymbol, t as createCsrfMiddleware } from "./createCsrfMiddleware-Dhng1qR6.mjs";
import processModule from "node:process";
import { AsyncLocalStorage } from "node:async_hooks";
//#region node_modules/.nitro/vite/services/ssr/assets/server-Bz1Ulc6b.js
init_globalthis();
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-SyThVD3n.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CbcPHhf4.mjs"),
		import("./start-BPGwucid.mjs"),
