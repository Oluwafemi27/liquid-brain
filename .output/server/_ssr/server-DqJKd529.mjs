...
//#region node_modules/.nitro/vite/services/ssr/assets/server-DqJKd529.js
init_globalthis();
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C1QjCk_s.mjs");
