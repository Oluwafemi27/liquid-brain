...
//#region node_modules/.nitro/vite/services/ssr/assets/server-Ds5cUIsX.js
init_globalthis();
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-R8BVfCHz.mjs");
